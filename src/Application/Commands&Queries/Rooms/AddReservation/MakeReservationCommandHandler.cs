...
{
    public sealed class MakeReservationCommandHandler : IRequestHandler<MakeReservationCommand>
    {
        private readonly IUnitOfWork _unitOfWork;

        public MakeReservationCommandHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<Unit> Handle(MakeReservationCommand command, CancellationToken cancellationToken)
        {
